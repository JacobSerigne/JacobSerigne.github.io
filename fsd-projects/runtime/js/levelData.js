    ...
    var levelData = [
      {
        ...
        speed: -3,
        gameItems: [
        { type: "sawblade", x: 400, y: groundY - 10, damage: 10, image:'img/redLight.png' },
        { type: "sawblade", x: 600, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 800, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 1500, y: groundY - 10, damage: 10, image:'img/redLight.png'  },
        { type: "sawblade", x: 1700, y: groundY - 10, damage: 10 ,image: 'img/redLight.png' },
        { type: "sawblade", x: 2000, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
      ...
      },
      {
        ...
        speed: -3,
        gameItems: [
        { type: "sawblade", x: 500, y: groundY - 10, damage: 10, image: 'img/redLight.png'  },
        { type: "sawblade", x: 800, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 1000, y: groundY - 10, damage: 10, image: 'img/redLight.png'  },
        { type: "sawblade", x: 1200, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 1400, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 1600, y: groundY - 10, damage: 10 , image:'img/redLight.png' },
        { type: "sawblade", x: 1800, y: groundY - 125, damage: 10, image:'img/blueBall.png' }, 
        { type: "sawblade", x: 2000, y: groundY - 10, damage: 10, image:'img/redLight.png'  }, 
      ...
      },
      {
        ...
        speed: -5,
        gameItems: [
        { type: "sawblade", x: 500, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 800, y: groundY - 10, damage: 10, image:'img/redLight.png'  },
        { type: "sawblade", x: 1000, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 1200, y: groundY - 10, damage: 10, image:'img/redLight.png'  },
        { type: "sawblade", x: 1400, y: groundY - 125, damage: 10, image:'img/blueBall.png' },
        { type: "sawblade", x: 1600, y: groundY - 10, damage: 10, image:'img/redLight.png'  },
